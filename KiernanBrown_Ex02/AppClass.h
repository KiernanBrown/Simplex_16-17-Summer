...
private:
	String m_sProgrammer = "Kiernan Brown - kwb6721@g.rit.edu"; //programmer

	Map* m_pMap = nullptr;					// Map Pointer
	bool m_bPlaneOverlay = false;			// Are we using the plane overlay
	Pathfinder* m_pPathfinder = nullptr;	// Pathfinder Pointer
	MapNode* m_pSelectedNode = nullptr;		// Selected MapNode
	vector3 m_v3NewSelectedPos;				// Used for changing the selected node
