...
class Application
{
	std::vector<uint> paths;						// Vector of unsigned ints used to represent the path the sphere is following
	std::vector<std::vector<vector3>> pathPoints;	// Vector of vector3s used to hold the points on the path
	bool rotating = false;							// Are the tori going to rotate?
	std::vector<quaternion> rotations;				// Vector of quaternions for rotating the tori
	std::vector<float> rotFloats;					// Vector of floats for rotating the tori
	...
	String m_sProgrammer = "Kiernan Brown - kwb6721@g.rit.edu";
