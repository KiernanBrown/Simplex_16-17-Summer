...
class MyCamera
{
	...
	vector3 m_v3Direction = vector3(0.0f, 0.0f, -1.0f); // What direction am I facing
	vector3 m_v3Right = vector3(1.0f, 0.0f, 0.0f);		// What vector points to the right
	vector3 m_v3Top = vector3(1.0f, 0.0f, 0.0f);		// Top	
	vector3 m_v3YawPitchRoll = vector3(0.0f, 0.0f, 0.0f); // Yaw, Pitch, and Roll of the camera
...
public:
	...
	*/
	...
	// Method that returns the direction we are facing
	vector3 GetDirection(void);

	// Method to set our direciton
	void SetDirection(vector3 a_v3Direction);

	// Method that returns the vector to the right of where we are facing
	vector3 GetRight(void);

	// Method to set our right vector
	void SetRight(vector3 a_v3Right);

	// Method that reeturns our yaw, pitch, and roll
	vector3 GetYawPitchRoll(void);

	// Method to change our yaw, pitch, and roll
	void ChangeYawPitchRoll(vector3 a_v3YawPitchRoll);
};
