...
void Simplex::MyCamera::SetDirection(vector3 a_v3Direction) { m_v3Direction = a_v3Direction; }

void Simplex::MyCamera::SetRight(vector3 a_v3Right) { m_v3Right = a_v3Right; }

// Method to change our yaw, pitch, and roll of our camera
void Simplex::MyCamera::ChangeYawPitchRoll(vector3 a_v3YawPitchRoll)
{
	m_v3YawPitchRoll += a_v3YawPitchRoll;
	m_v3Direction.x = cos(glm::radians(m_v3YawPitchRoll.y)) * cos(glm::radians(m_v3YawPitchRoll.x));
	m_v3Direction.y = sin(glm::radians(m_v3YawPitchRoll.y));
	m_v3Direction.z = cos(glm::radians(m_v3YawPitchRoll.y)) * sin(glm::radians(m_v3YawPitchRoll.x));
...
vector3 Simplex::MyCamera::GetDirection() { return m_v3Direction; }

vector3 Simplex::MyCamera::GetRight() { return m_v3Right; }

vector3 Simplex::MyCamera::GetYawPitchRoll() { return m_v3YawPitchRoll; }
