...
class MyRigidBody
{
	...
	vector3 m_v3Corners[8];					// Vector of corners of the cube
...
private:
	...
	*/
	...
	// Method that gets the min and max when given an array of corners from a RigidBody and an axis, and stores them into the two float pointers 
	void GetIntervals(vector3* corners, vector3 axis, float& min, float& max);
