...
void MyRigidBody::SetModelMatrix(matrix4 a_m4ModelMatrix)
{
	...
	corners.push_back(m_v3MinG);										// Min x, Min y, Min z
	corners.push_back(vector3(m_v3MaxG.x, m_v3MinG.y, m_v3MinG.z));	// Max x, Min y, Min z
	corners.push_back(vector3(m_v3MaxG.x, m_v3MaxG.y, m_v3MinG.z));	// Max x, Max y, Min z
	corners.push_back(vector3(m_v3MaxG.x, m_v3MinG.y, m_v3MaxG.z));	// Min x, Min y, Max z
	corners.push_back(vector3(m_v3MinG.x, m_v3MaxG.y, m_v3MinG.z));	// Min x, Max y, Min z
	corners.push_back(vector3(m_v3MinG.x, m_v3MaxG.y, m_v3MaxG.z));	// Min x, Max y, Max z
	corners.push_back(vector3(m_v3MinG.x, m_v3MinG.y, m_v3MaxG.z));	// Min x, Min y, Max z
	corners.push_back(m_v3MaxG);										// Max x, Max y, Max z

	// Globalize the corners
	for (int i = 0; i < corners.size(); i++)
	{
		corners[i] = vector3(m_m4ToWorld * vector4(corners[i], 1.0f));
	}

	// Set the min and max to be the first corner
