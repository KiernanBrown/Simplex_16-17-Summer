...
#pragma endregion
	...
	//About
	{
		...
		ImGui::Begin(sAbout.c_str(), (bool*)0, window_flags);
		{
			...
			ImGui::Text("	 R: Make Primitive Rotate\n");
			if (rotating)
			{
				ImGui::TextColored(ImVec4(C_GREEN.x, C_GREEN.y, C_GREEN.z, 1.0f), "	  | Rotating\n");
			}
			else
			{
				ImGui::TextColored(ImVec4(C_RED.x, C_RED.y, C_RED.z, 1.0f), "	  | Not Rotating\n");
			}
		}
		ImGui::End();
	}
